...
call s:hi('IncSearch',                          s:base01, s:red,    s:none)
...
call s:hi('CursorLine',                         '',       s:base01, s:none)
...
call s:hi('javaScriptNumber',                   s:red,    '',       '')
...
call s:hi('markdownCodeDelimiter',              s:gray,   '',       s:italic)
...
call s:hi('NeomakeError',                       s:red,    '',       'underline')
call s:hi('NeomakeWarning',                     s:red,    '',       'underline')
